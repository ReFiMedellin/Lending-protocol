...
import "../src/ReFiMedLendUpgradeable.sol";
...
contract ReFiMedLendTest is Test {
    ...
    ReFiMedLendUpgradeable public refiMedLend;
    ...
    function setUp() public {
        refiMedLend = new ReFiMedLendUpgradeable();
        refiMedLend.initialize(owner, owner, owner);
        token = new MockERC20();
